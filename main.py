...
from config import *
from example import BatchSamplerNormal,BatchSamplerAbnormal
...
if __name__ == '__main__':
    ...
    nor_ind = BatchSamplerNormal()
    abn_ind = BatchSamplerAbnormal()
    train_nloader = DataLoader(Dataset(args, test_mode=False, is_normal=True),
                               batch_sampler=nor_ind, pin_memory=False, drop_last=False)
    train_aloader = DataLoader(Dataset(args, test_mode=False, is_normal=False),
                               batch_sampler=abn_ind, pin_memory=False, drop_last=False)
    # train_nloader = DataLoader(Dataset(args, test_mode=False, is_normal=True),
